...
window.PREDICTIONS_DATA = [
  ...
  },
  {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Dylan Crews(0.596)",
            "CJ Abrams(0.909)",
            "Andrés Chaparro(0.798)",
            "Jorbit Vivas(0.663)",
            "Yohandy Morales(0.893)",
            "Keibert Ruiz(0.706)",
            "Nasim Nuñez(0.466)"
          ],
          "lineup_players": [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Hao-Yu Lee(0.830)",
            "Kevin McGonigle(0.887)",
            "Eduardo Valencia(0.989)",
            "Ben Malgeri(0.844)",
            "Max Clark(0.765)",
            "Spencer Torkelson(0.988)",
            "Javier Báez(0.556)",
            "John Peck(0.350)"
          ],
          "lineup_players": [
    ...
    "scores": {
      "away_offense": 32.3,
      "away_defense": 36.2,
      "home_offense": 27.799999999999997,
      "home_defense": 55.8
    },
    "actual_score": {
      "away": 3,
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Jackson Chourio(0.734)",
            "Brice Turang(0.969)",
            "William Contreras(0.915)",
            "Jake Bauers(0.901)",
            "Christian Yelich(0.604)",
            "Luis Lara(0.560)",
            "Cooper Pratt(0.710)",
            "David Hamilton(0.474)"
          ],
          "lineup_players": [
            {
              "id": 669003,
  ...
  },
  {
    ...
    "model_correct": true,
    "notes": "Cleveland Guardians IL: Colin Holderman, Rhys Hoskins, Shawn Armstrong / Boston Red Sox IL: Anthony Seigler, Ceddanne Rafaela, Curtis Mead, Eduardo Rivera, Eli White 외 다수",
    "kalshi_prob": null,
    "edge": null,
    "value_bet": "마켓 없음",
    "extreme_edge": false,
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 2.4pt (≤5.0pt) / 최고 확률 52.7% (≤58.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 1.8pt (≤5.0pt) / 최고 확률 51.5% (≤58.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Drew Gilbert(0.951)",
            "Jonah Cox(0.643)",
            "Victor Bericoto(0.617)",
            "Turner Hill(0.556)",
            "Bo Davidson(0.661)",
            "Shay Whitcomb(0.571)",
            "Scott Bandura(0.465)",
            "Drew Cavanaugh(0.538)",
            "Christian Koss(0.572)"
          ],
          "lineup_players": [
            {
              "id": 687551,
  ...
  },
  {
    ...
    "scores": {
      "away_offense": 61.400000000000006,
      "away_defense": 63.4,
      "home_offense": 58.2,
      "home_defense": 43.5
    },
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Brett Bateman(0.845)",
            "Alejandro Kirk(0.860)",
            "Nathan Lukes(0.680)",
            "George Springer(0.726)",
            "Sean Keys(0.695)",
            "Kazuma Okamoto(0.755)",
            "Josh Smith(0.454)",
            "Andrés Giménez(0.641)",
            "Ernie Clement(0.491)"
          ],
          "lineup_players": [
            {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Dylan Beavers(0.572)",
            "Pete Alonso(0.956)",
            "Gunnar Henderson(0.859)",
            "Coby Mayo(0.758)",
            "Christian Encarnacion-Strand(0.853)",
    ...
    "kalshi_prob": 78.0,
    "edge": -15.6,
    "value_bet": "⚠️ 시장이 더 높게 평가 (회피 고려: Baltimore Orioles)",
    "extreme_edge": false,
    "consensus": false,
    "sp_bat_conflict": false,
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 57.2% (≤58.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
