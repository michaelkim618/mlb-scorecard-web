...
window.PREDICTIONS_DATA = [
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Henry Bolte(0.758)",
            "Lawrence Butler(0.906)",
            "Shea Langeliers(0.732)",
            "Jeff McNeil(0.694)",
            "Zack Gelof(1.021)",
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Fernando Tatis(0.877)",
            "Dustin Harris(0.728)",
            "Manny Machado(0.616)",
            "Ty France(0.856)",
            "Jackson Merrill(0.770)",
            "Xander Bogaerts(0.766)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Shohei Ohtani(0.669)",
            "Will Smith(0.931)",
            "Freddie Freeman(0.647)",
            "Teoscar Hernández(0.807)",
            "Kyle Tucker(0.976)",
            "Andy Pages(0.905)",
            "Max Muncy(0.712)",
            "Tommy Edman(0.589)"
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 1.9pt (≤5.0pt) / 최고 확률 54.4% (≤58.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
