...
window.PREDICTIONS_DATA = [
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Carlos Jorge(0.417)",
            "Elly De La Cruz(1.065)",
            "Sal Stewart(0.797)",
            "Tyler Stephenson(0.744)",
            "JJ Bleday(0.586)",
            "Eugenio Suárez(0.775)",
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Konnor Griffin(0.747)",
            "Brandon Lowe(0.949)",
            "Bryan Reynolds(0.732)",
            "Oneil Cruz(0.927)",
            "Nick Gonzales(0.699)",
            "Ryan O'Hearn(0.671)",
            "Ronny Simon(0.762)",
  ...
  },
  {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Dylan Beavers(0.632)",
            "Pete Alonso(0.930)",
            "Gunnar Henderson(0.750)",
            "Coby Mayo(0.855)",
            "Samuel Basallo(0.607)",
            "Christian Encarnacion-Strand(0.860)",
            "Colton Cowser(0.690)",
    ...
    "scores": {
      "away_offense": 53.7,
      "away_defense": 45.9,
      "home_offense": 29.799999999999997,
      "home_defense": 46.7
    },
    "actual_score": {
      "away": 6,
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 2.0pt (≤5.0pt) / 최고 확률 53.6% (≤58.0%)",
    "model_version": "v14"
  },
  {
    "date": "2026-09-18",
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Henry Bolte(0.764)",
            "Shea Langeliers(0.814)",
            "Lawrence Butler(0.765)",
            "Zack Gelof(0.672)",
            "Jeff McNeil(0.629)",
            "Tommy White(0.566)",
            "Jonah Heim(0.447)",
            "Michael Stefanic(0.645)",
            "Alika Williams(0.609)"
          ],
          "lineup_players": [
            {
              "id": 703607,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Jo Adell(0.716)",
            "Travis Bazzana(1.012)",
            "Nathaniel Lowe(0.815)",
            "Patrick Bailey(0.570)",
            "Petey Halpin(0.577)",
            "Brayan Rocchio(0.732)"
          ],
          "lineup_players": [
            {
              "id": 680757,
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Yandy Díaz(0.615)",
            "Jonathan Aranda(0.855)",
            "Junior Caminero(0.805)",
            "Ryan Vilade(0.766)",
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 4.5pt (≤5.0pt) / 최고 확률 53.4% (≤58.0%)",
    "model_version": "v14"
  },
  {
    "date": "2026-09-18",
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Brett Bateman(0.788)",
            "Nathan Lukes(0.693)",
            "Vladimir Guerrero Jr.(0.743)",
            "George Springer(0.748)",
            "Alejandro Kirk(0.830)",
            "Kazuma Okamoto(0.994)",
            "Josh Smith(0.729)",
            "Ernie Clement(0.500)",
            "Myles Straw(0.683)"
          ],
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Ezequiel Duran(0.574)",
            "Corey Seager(0.831)",
            "Josh Jung(0.808)",
            "Brandon Nimmo(0.647)",
            "Wyatt Langford(0.788)",
            "Jake Burger(0.702)",
            "Nicky Lopez(0.776)",
            "Elias Díaz(0.693)",
            "Evan Carter(0.466)"
  ...
  },
  {
    ...
    "model_correct": true,
    "notes": "Atlanta Braves IL: Bryce Elder, Joe Jiménez, Joey Wentz, Lane Thomas, Reynaldo López 외 다수 / Houston Astros IL: Brandon Walter, Carlos Correa, Mike Burrows, Steven Okert",
    "kalshi_prob": null,
    "edge": null,
    "value_bet": "마켓 없음",
    "extreme_edge": false,
