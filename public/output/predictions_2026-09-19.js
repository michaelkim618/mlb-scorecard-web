...
window.PREDICTIONS_DATA = [
  ...
  },
  {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Lawrence Butler(0.831)",
            "Zack Gelof(0.693)",
            "Donovan Walton(0.794)",
            "Carlos Cortes(0.638)",
            "Brian Serven(0.537)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Steven Kwan(0.818)",
            "José Ramírez(0.652)",
            "Chase DeLauter(0.836)",
            "Jo Adell(0.712)",
            "Angel Martínez(0.911)",
            "David Fry(0.633)",
            "Travis Bazzana(0.891)",
            "Austin Hedges(0.613)",
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 4.2pt (≤5.0pt)",
    "model_version": "v15"
  },
  {
    "date": "2026-09-19",
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Cal Raleigh(0.673)",
            "Julio Rodríguez(0.764)",
            "Josh Naylor(0.667)",
            "Michael Arroyo(1.049)",
            "Lazaro Montes(0.847)",
            "Weston Wilson(0.649)"
          ],
          "lineup_players": [
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Ben Rice(0.986)",
            "Cody Bellinger(0.906)",
            "Luis García Jr.(0.769)",
            "Heliot Ramos(0.861)",
            "George Lombard Jr.(0.698)",
            "Austin Wells(0.772)",
            "Anthony Volpe(0.700)",
            "Ryan McMahon(0.471)",
            "José Caballero(0.732)"
          ],
          "lineup_players": [
            {
              "id": 700250,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Lars Nootbaar(0.660)",
            "Ketel Marte(0.667)",
            "Gabriel Moreno(0.978)",
            "Geraldo Perdomo(0.752)",
            "Corbin Carroll(0.786)",
            "Nolan Arenado(1.067)",
            "Tim Tawa(0.667)",
            "Jesús Sánchez(0.561)",
            "Jordan Lawlar(0.801)"
    ...
    "scores": {
      "away_offense": 41.4,
      "away_defense": 73.5,
      "home_offense": 35.699999999999996,
      "home_defense": 58.5
    },
    "actual_score": {
      "away": 3,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Manny Machado(0.627)",
            "Ty France(0.977)",
            "Jackson Merrill(0.926)",
            "Luis Campusano(0.663)",
            "Jake Cronenworth(0.809)",
            "Samad Taylor(1.006)",
            "Freddy Fermin(0.567)"
          ],
          "lineup_players": [
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jonah Cox(0.711)",
            "Turner Hill(0.601)",
            "Victor Bericoto(0.678)",
            "Jung Hoo Lee(0.678)",
            "Brett Harris(0.477)",
            "Shay Whitcomb(0.546)",
            "Andrew Knizner(0.663)",
            "Osleivis Basabe(0.607)",
            "Christian Koss(0.611)"
          ],
          "lineup_players": [
            {
              "id": 813841,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Mookie Betts(1.062)",
            "Freddie Freeman(0.577)",
            "Will Smith(0.941)",
            "Max Muncy(0.845)",
            "Teoscar Hernández(0.729)",
            "Kyle Tucker(1.126)",
            "Josue De Paula(0.897)",
            "Tommy Edman(0.451)",
            "Alex Freeland(0.839)"
          ],
          "lineup_players": [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Mike Trout(0.774)",
            "Wade Meckler(0.660)",
            "Vaughn Grissom(0.667)",
            "Moisés Ballesteros(0.677)",
            "Denzer Guzman(0.573)",
            "Josh Lowe(0.696)",
            "Jose Siri(0.795)",
