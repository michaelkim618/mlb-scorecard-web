...
window.PREDICTIONS_DATA = [
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Dane Myers(0.721)",
            "Elly De La Cruz(1.054)",
            "Sal Stewart(0.780)",
            "Tyler Stephenson(0.759)",
            "Juan Brito(0.841)",
            "Matt McLain(0.513)",
            "Héctor Rodríguez(0.470)",
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Yandy Díaz(0.611)",
            "Jonathan Aranda(0.865)",
            "Junior Caminero(0.869)",
            "Liam Hicks(0.788)",
            "Jonny DeLuca(0.656)",
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Maikel Garcia(0.670)",
            "Michael Massey(0.760)",
            "Salvador Perez(0.579)",
            "John Rave(0.860)",
            "Kyle Isbel(0.449)",
            "Isaac Collins(0.594)"
          ],
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jeremy Peña(0.925)",
            "Yordan Alvarez(0.974)",
            "Isaac Paredes(0.827)",
            "Jose Altuve(0.601)",
            "Yainer Diaz(0.829)",
            "Daulton Varsho(0.623)",
            "Taylor Trammell(0.648)",
            "Cam Smith(0.678)",
            "LaMonte Wade Jr.(0.713)"
          ],
          "lineup_players": [
            {
              "id": 665161,
    ...
    "scores": {
      "away_offense": 17.8,
      "away_defense": 24.0,
      "home_offense": 31.599999999999998,
      "home_defense": 43.9
    },
    "actual_score": {
      "away": 2,
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Kevin McGonigle(0.926)",
            "Gleyber Torres(0.650)",
            "Dillon Dingler(0.600)",
            "Riley Greene(0.865)",
            "Spencer Torkelson(0.975)",
            "Zach McKinstry(0.476)",
            "Max Clark(0.871)",
            "John Peck(0.545)",
            "Javier Báez(0.446)"
          ],
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Chase Meidroth(0.808)",
            "Tommy Pham(0.519)",
            "Miguel Vargas(0.793)",
            "Randal Grichuk(1.020)",
            "Munetaka Murakami(0.769)",
            "Brenton Doyle(0.771)",
            "Jake Rogers(0.456)",
