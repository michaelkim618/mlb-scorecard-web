...
window.PREDICTIONS_DATA = [
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Jackson Chourio(0.918)",
            "Brice Turang(1.046)",
            "William Contreras(0.845)",
            "Andrew Vaughn(0.719)",
            "Christian Yelich(0.635)",
            "Joey Ortiz(0.885)",
            "Garrett Mitchell(0.901)",
            "Luis Lara(0.553)",
            "Cooper Pratt(0.704)"
          ],
          "lineup_players": [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Dylan Beavers(0.632)",
            "Pete Alonso(0.943)",
            "Gunnar Henderson(0.761)",
            "Coby Mayo(0.860)",
            "Samuel Basallo(0.615)",
            "Christian Encarnacion-Strand(0.877)",
            "Colton Cowser(0.690)",
    ...
    "scores": {
      "away_offense": 54.5,
      "away_defense": 45.4,
      "home_offense": 30.200000000000003,
      "home_defense": 47.5
    },
    "actual_score": {
      "away": 6,
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Yandy Díaz(0.615)",
            "Jonathan Aranda(0.868)",
            "Junior Caminero(0.816)",
            "Ryan Vilade(0.766)",
            "Chandler Simpson(0.689)",
            "Jonny DeLuca(0.634)",
            "Nick Fortes(0.843)",
            "Victor Mesa Jr.(1.035)",
            "Taylor Walls(0.643)"
          ],
          "lineup_players": [
            {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 4.5pt (≤5.0pt) / 최고 확률 53.3% (≤58.0%)",
    "model_version": "v14"
  },
  {
    "date": "2026-09-18",
