        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 360px", gap: 24, alignItems: "start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div style={{
              ...
              {user ? (
                  ...
                  <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
                    ...
                    <textarea
                      ...
                      style={{
                        ...
                        outline: "none", resize: "none", padding: "8px 12px",
                ...
                <div style={{ textAlign: "center", padding: "12px 0" }}>
                  <p className="t-caption" style={{ color: "var(--color-muted)", marginBottom: 12 }}>
            ...
            {comments.length === 0 && (
              <div style={{
                background: "var(--color-canvas)", borderRadius: "var(--radius-lg)",
                padding: "32px", textAlign: "center", border: "1px solid var(--color-border)",
              }}>
            ...
            {comments.map((c) => (
              <div key={c.id} style={{
                ...
                <p className="t-body" style={{ color: "var(--color-body)", lineHeight: 1.55, fontSize: 14 }}>{c.content}</p>
            ...
            {loading ? null : user ? (
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                  ...
                  <div>
                    <div className="t-caption-strong" style={{ color: "var(--color-ink)" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600, fontSize: 13, border: "1px solid var(--color-border)",
                    cursor: "pointer",
                  }}>
                  Sign Out
                </button>
