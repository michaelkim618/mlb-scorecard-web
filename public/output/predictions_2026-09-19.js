...
window.PREDICTIONS_DATA = [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Steven Kwan(0.802)",
            "José Ramírez(0.660)",
            "Chase DeLauter(0.821)",
            "Jo Adell(0.720)",
            "Angel Martínez(0.927)",
            "David Fry(0.633)",
            "Travis Bazzana(0.907)",
            "Austin Hedges(0.613)",
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 2.3pt (≤5.0pt) / 최고 확률 50.7% (≤58.0%)",
    "model_version": "v15"
  },
  {
    "date": "2026-09-19",
