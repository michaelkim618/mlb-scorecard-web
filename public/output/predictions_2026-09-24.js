...
window.PREDICTIONS_DATA = [
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Kyle Teel(0.669)",
            "Miguel Vargas(0.890)",
            "Munetaka Murakami(0.952)",
            "Andrew Benintendi(0.583)",
            "Tristan Peters(0.492)",
            "Chase Meidroth(0.897)",
            "Colson Montgomery(0.478)",
            "Braden Montgomery(0.701)"
          ],
          "lineup_players": [
            {
              "id": 803011,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Carter Jensen(0.824)",
            "Bobby Witt Jr.(0.787)",
            "Vinnie Pasquantino(0.941)",
            "Salvador Perez(0.609)",
            "Michael Massey(0.643)",
            "Nick Loftin(0.748)",
            "John Rave(0.800)",
            "Kyle Isbel(0.434)",
            "Isaac Collins(0.457)"
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 1.4pt (≤5.0pt) / 최고 확률 56.7% (≤62.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Jake Burger(0.661)",
            "Brandon Nimmo(0.673)",
            "Wyatt Langford(0.706)",
            "Ezequiel Duran(0.551)",
            "Elias Díaz(0.580)",
            "Danny Jansen(0.666)"
          ],
          "lineup_players": [
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Geraldo Perdomo(0.901)",
            "Pavin Smith(0.778)",
            "Nolan Arenado(1.006)",
            "Corbin Carroll(0.865)",
            "James McCann(0.753)",
            "Tim Tawa(0.538)"
          ],
          "lineup_players": [
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 57.1% (≤62.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
  ...
  },
  {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Steven Kwan(0.732)",
            "José Ramírez(0.748)",
            "Chase DeLauter(0.746)",
            "Jo Adell(0.648)",
            "Angel Martínez(1.056)",
            "David Fry(0.592)",
            "Travis Bazzana(0.695)",
            "Patrick Bailey(0.539)",
            "Brayan Rocchio(0.733)"
          ],
          "lineup_players": [
            {
              "id": 680757,
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 54.5% (≤62.0%)",
    "opener_game": {
      "away": true,
      "home": false
    },
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jeremy Peña(0.894)",
            "Yordan Alvarez(1.144)",
            "Isaac Paredes(0.873)",
            "Jose Altuve(0.720)",
            "Yainer Diaz(0.867)",
            "Christian Walker(0.660)",
            "Cam Smith(0.425)",
            "Lucas Spence(0.821)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Henry Bolte(0.758)",
            "Lawrence Butler(0.827)",
            "Shea Langeliers(0.721)",
            "Jeff McNeil(0.718)",
            "Zack Gelof(0.955)",
            "Donovan Walton(0.822)",
            "Carlos Cortes(0.669)",
    ...
    "scores": {
      "away_offense": 36.300000000000004,
      "away_defense": 53.1,
