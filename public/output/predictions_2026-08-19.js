// Auto-generated (scorecard) — 2026-08-19
window.PREDICTIONS_DATA = [
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Ben Rice(0.700)",
            "Heliot Ramos(0.517)",
            "Luis García Jr.(0.699)",
            "Spencer Jones(0.659)",
            "Jazz Chisholm Jr.(0.591)",
            "George Lombard Jr.(0.762)",
            "Ryan McMahon(0.658)",
            "Austin Wells(0.661)"
          ],
          "lineup_players": [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Jackson Holliday(0.757)",
            "Pete Alonso(1.220)",
            "Tyler O'Neill(0.708)",
            "Coby Mayo(0.774)",
            "Gunnar Henderson(0.819)",
            "Christian Encarnacion-Strand(0.895)",
            "Leody Taveras(0.721)",
            "Christian Franklin(0.666)",
            "Carlos Narváez(0.396)"
          ],
          "lineup_players": [
            {
              "id": 702616,
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Gleyber Torres(0.788)",
            "Kevin McGonigle(0.691)",
            "Colt Keith(0.770)",
            "Eduardo Valencia(1.123)",
            "Zach McKinstry(0.661)",
            "Spencer Torkelson(0.740)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Spencer Horwitz(0.562)",
            "Brandon Lowe(0.750)",
            "Bryan Reynolds(0.673)",
            "Esmerlyn Valdez(0.821)",
            "Oneil Cruz(1.036)",
            "Jake Mangum(0.803)",
            "Rafael Flores Jr.(0.978)",
            "Jacob Gonzalez(0.645)",
            "Jared Triolo(0.641)"
          ],
          "lineup_players": [
            {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jonah Cox(0.637)",
            "Rafael Devers(0.776)",
            "Victor Bericoto(0.698)",
            "Bryce Eldridge(0.798)",
            "Osleivis Basabe(0.689)",
            "Buddy Kennedy(0.330)",
            "Drew Gilbert(0.776)",
            "Andrew Knizner(0.250)",
            "Christian Koss(0.488)"
          ],
          "lineup_players": [
            {
              "id": 813841,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "José Ramírez(0.758)",
            "Jo Adell(0.755)",
            "Angel Martínez(0.741)",
            "Rhys Hoskins(0.694)",
            "Angel Genao(0.772)",
            "Travis Bazzana(0.530)",
            "Patrick Bailey(0.536)",
            "Brayan Rocchio(0.623)"
          ],
          "lineup_players": [
            {
              "id": 680757,
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Elly De La Cruz(0.583)",
            "Sal Stewart(0.792)",
            "JJ Bleday(0.661)",
            "Eugenio Suárez(0.778)",
            "Tyler Stephenson(0.763)",
            "Dane Myers(0.751)",
            "Matt McLain(0.624)",
            "Héctor Rodríguez(0.337)",
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Brett Bateman(0.635)",
            "Nathan Lukes(0.667)",
            "Alejandro Kirk(0.954)",
            "George Springer(0.554)",
            "Jesús Sánchez(0.812)",
            "Kazuma Okamoto(0.631)",
            "Andrés Giménez(0.697)",
            "Ernie Clement(0.628)",
            "Josh Smith(0.672)"
          ],
          "lineup_players": [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Chandler Simpson(0.783)",
            "Junior Caminero(0.718)",
            "Jonathan Aranda(0.704)",
            "Yandy Díaz(0.948)",
            "Liam Hicks(0.856)",
            "Victor Mesa Jr.(0.812)",
            "Cedric Mullins(0.639)",
            "Richie Palacios(0.861)",
            "Taylor Walls(0.745)"
          ],
          "lineup_players": [
            {
    ...
    "kalshi_prob": 34.0,
    "edge": 26.0,
    "value_bet": "✅ Value Bet 후보 (Tampa Bay Rays)",
    "extreme_edge": false,
    "consensus": false
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jakob Marsee(0.676)",
            "Xavier Edwards(0.711)",
            "Otto Lopez(0.662)",
            "Griffin Conine(1.171)",
            "Heriberto Hernández(0.748)",
            "Agustín Ramírez(0.831)",
            "Owen Caissie(0.688)",
            "Javier Sanoja(0.772)",
            "Brian Navarreto(0.537)"
          ],
          "lineup_players": [
            {
              "id": 805300,
  ...
  },
  {
    ...
    "model_correct": true,
    "notes": "San Diego Padres IL: Bryan Hoeing, Jason Adam, Joe Musgrove, Lucas Giolito, Miguel Andujar 외 다수 / New York Mets IL: Cionel Pérez, Devin Williams, Juan Soto, Justin Hagenman, Mark Vientos 외 다수",
    "kalshi_prob": 48.0,
    "edge": -2.7,
    "value_bet": "➖ 시장과 유사",
    "extreme_edge": false,
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Brendan Donovan(0.601)",
            "Randy Arozarena(0.779)",
            "Dominic Canzone(0.810)",
            "Julio Rodríguez(0.776)",
            "Josh Naylor(0.803)",
            "Cole Young(0.621)",
            "Cal Raleigh(0.519)",
            "Victor Robles(0.806)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Jake Bauers(0.916)",
            "William Contreras(0.580)",
            "Christian Yelich(0.590)",
            "Luis Lara(0.585)",
            "Garrett Mitchell(0.609)",
            "Joey Ortiz(0.760)",
            "David Hamilton(0.625)"
          ],
          "lineup_players": [
            {
              "id": 668930,
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Miguel Vargas(0.888)",
            "Andrew Benintendi(0.738)",
            "Braden Montgomery(0.776)",
            "Colson Montgomery(0.623)",
            "Chase Meidroth(0.871)",
            "Tristan Peters(0.948)",
            "Drew Romo(0.498)"
          ],
          "lineup_players": [
            {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Wade Meckler(0.635)",
            "Mike Trout(0.810)",
            "Nolan Schanuel(0.838)",
            "Zach Neto(0.599)",
            "Moisés Ballesteros(0.490)",
            "Vaughn Grissom(0.546)",
            "Josh Lowe(0.615)",
            "Denzer Guzman(0.574)",
            "Tyler Heineman(0.460)"
          ],
          "lineup_players": [
            {
              "id": 685133,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jeremy Peña(0.591)",
            "Yordan Alvarez(0.861)",
            "Isaac Paredes(0.855)",
            "Jose Altuve(0.807)",
            "Daulton Varsho(0.530)",
            "Christian Walker(0.674)",
            "Taylor Trammell(0.674)",
            "Cam Smith(0.866)",
            "Yainer Diaz(0.536)"
          ],
          "lineup_players": [
  ...
  },
  {
    ...
    "model_correct": true,
    "notes": "Los Angeles Dodgers IL: Ben Casparius, Blake Treinen, Bobby Miller, Brock Stewart, Brusdar Graterol 외 다수 / Colorado Rockies IL: Chase Dollander, Hunter Goodman, Jaden Hill, Jose Quintana, Kris Bryant 외 다수",
    "kalshi_prob": 35.0,
    "edge": 2.0,
    "value_bet": "➖ 시장과 유사",
    "extreme_edge": false,
