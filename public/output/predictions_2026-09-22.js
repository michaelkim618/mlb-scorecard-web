...
window.PREDICTIONS_DATA = [
  ...
  },
  {
    ...
    "scores": {
      "away_offense": 25.0,
      "away_defense": 51.1,
      "home_offense": 34.699999999999996,
      "home_defense": 55.7
    },
    "actual_score": {
      "away": 0,
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 55.2% (≤58.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Garrett Mitchell(0.880)",
            "Jackson Chourio(0.652)",
            "Brice Turang(0.924)",
            "William Contreras(0.907)",
            "Jake Bauers(0.841)",
    ...
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 55.3% (≤58.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Steven Kwan(0.845)",
            "José Ramírez(0.674)",
            "Chase DeLauter(0.790)",
            "Jo Adell(0.735)",
            "Angel Martínez(0.986)",
            "David Fry(0.621)",
            "Travis Bazzana(0.803)",
            "Austin Hedges(0.632)",
            "Brayan Rocchio(0.746)"
          ],
          "lineup_players": [
            {
              "id": 680757,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Jahmai Jones(0.578)",
            "Wilyer Abreu(0.672)",
            "Adley Rutschman(0.714)",
            "Caleb Durbin(0.807)",
            "Andruw Monasterio(0.433)",
            "Isiah Kiner-Falefa(0.398)",
            "Nate Eaton(0.487)"
          ],
          "lineup_players": [
            {
  ...
  },
  {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Sal Stewart(0.678)",
            "Tyler Stephenson(0.635)",
            "JJ Bleday(0.754)",
            "Eugenio Suárez(0.756)",
            "Dane Myers(0.631)",
    ...
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 52.9% (≤58.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
  ...
  },
  {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Miguel Vargas(0.948)",
            "Tommy Pham(0.641)",
            "Randal Grichuk(0.921)",
            "Munetaka Murakami(0.789)",
            "Chase Meidroth(0.851)",
            "Kyle Teel(0.550)",
            "Brenton Doyle(0.755)",
            "Colson Montgomery(0.531)",
            "Braden Montgomery(0.628)"
          ],
          "lineup_players": [
            {
              "id": 678246,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Salvador Perez(0.522)",
            "Michael Massey(0.693)",
            "Nick Loftin(0.748)",
            "Kyle Isbel(0.375)"
          ],
          "lineup_players": [
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 2.0pt (≤5.0pt) / 최고 확률 50.3% (≤58.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Heriberto Hernández(0.697)",
            "Otto Lopez(0.734)",
            "Kyle Stowers(0.725)",
            "Javier Sanoja(0.857)",
            "Agustín Ramírez(0.865)",
            "Esteury Ruiz(0.543)",
            "Griffin Conine(0.785)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Pete Crow-Armstrong(0.971)",
            "Seiya Suzuki(0.726)",
            "Michael Busch(0.843)",
            "Michael Conforto(0.757)",
            "Ian Happ(0.790)",
            "Nico Hoerner(0.586)",
            "Pedro Ramírez(0.675)",
            "Carson Kelly(0.701)",
            "Dansby Swanson(0.822)"
          ],
          "lineup_players": [
            {
              "id": 691718,
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Wyatt Langford(0.753)",
            "Corey Seager(0.681)",
            "Josh Jung(0.814)",
            "Jake Burger(0.676)",
            "Brandon Nimmo(0.704)",
            "Ezequiel Duran(0.581)",
            "Justin Foscue(0.720)",
            "Elias Díaz(0.604)",
            "Danny Jansen(0.719)"
          ],
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Ildemaro Vargas(0.700)",
            "Ketel Marte(0.635)",
            "Gabriel Moreno(1.035)",
            "Geraldo Perdomo(0.807)",
            "Nolan Arenado(0.980)",
            "Jordan Lawlar(0.788)",
            "Corbin Carroll(0.808)",
            "Tim Tawa(0.645)",
    ...
    "scores": {
      "away_offense": 44.699999999999996,
      "away_defense": 58.3,
      "home_offense": 35.7,
      "home_defense": 33.3
    },
  ...
  },
  {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Zach Neto(0.751)",
            "Mike Trout(0.871)",
            "Vaughn Grissom(0.775)",
            "Denzer Guzman(0.587)",
            "Moisés Ballesteros(0.632)",
            "Jose Siri(0.724)",
            "Wade Meckler(0.676)",
            "Christian Moore(0.383)",
            "Bryce Teodosio(0.322)"
          ],
          "lineup_players": [
            {
              "id": 687263,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Lawrence Butler(0.847)",
            "Zack Gelof(0.834)",
            "Tommy White(0.641)",
            "Joshua Kuroda-Grauer(0.961)",
            "Jonah Heim(0.417)",
            "Alika Williams(0.837)",
            "Denzel Clarke(0.450)"
          ],
          "lineup_players": [
            {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 52.3% (≤58.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Jose Altuve(0.735)",
            "Yainer Diaz(0.891)",
            "Christian Walker(0.503)",
            "Taylor Trammell(0.611)",
            "Cam Smith(0.418)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "J.P. Crawford(0.691)",
            "Randy Arozarena(1.074)",
            "Dominic Canzone(0.920)",
            "Cal Raleigh(0.652)",
            "Julio Rodríguez(0.812)",
            "Josh Naylor(0.621)",
            "Cole Young(0.651)",
            "Lazaro Montes(0.734)",
            "Brock Rodden(0.376)"
    ...
    "scores": {
      "away_offense": 33.800000000000004,
      "away_defense": 50.8,
      "home_offense": 25.299999999999997,
      "home_defense": 37.7
    },
    "actual_score": {
      "away": 7,
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Fernando Tatis Jr.(0.879)",
            "Dustin Harris(0.766)",
            "Manny Machado(0.708)",
            "Ty France(0.934)",
            "Jackson Merrill(0.769)",
            "Austin Hays(0.889)",
            "Xander Bogaerts(0.873)",
            "Luis Campusano(0.706)",
            "Jake Cronenworth(0.830)"
          ],
          "lineup_players": [
            {
              "id": 665487,
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 54.6% (≤58.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
