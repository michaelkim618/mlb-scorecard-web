...
window.PREDICTIONS_DATA = [
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Konnor Griffin(0.769)",
            "Brandon Lowe(0.940)",
            "Bryan Reynolds(0.674)",
            "Oneil Cruz(0.889)",
            "Nick Gonzales(0.691)",
            "Ryan O'Hearn(0.741)",
            "Rafael Flores Jr.(1.006)",
            "Spencer Horwitz(0.742)",
            "Jake Mangum(0.599)"
          ],
          "lineup_players": [
            {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Max Clark(0.766)",
            "Hao-Yu Lee(0.829)",
            "Kevin McGonigle(0.848)",
            "Eduardo Valencia(1.145)",
            "Riley Greene(0.816)",
            "Dillon Dingler(0.633)",
            "Brett Callahan(0.547)",
            "Spencer Torkelson(1.022)",
            "John Peck(0.384)"
          ],
          "lineup_players": [
            {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 59.6% (≤62.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 0.0pt (≤5.0pt) / 최고 확률 54.3% (≤62.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
