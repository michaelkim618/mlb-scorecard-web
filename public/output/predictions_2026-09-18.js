...
window.PREDICTIONS_DATA = [
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 1.9pt (≤5.0pt) / 최고 확률 53.0% (≤58.0%)",
    "model_version": "v14"
  },
  {
    "date": "2026-09-18",
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Fernando Tatis Jr.(0.977)",
            "Dustin Harris(0.859)",
            "Manny Machado(0.631)",
            "Ty France(0.980)",
            "Jackson Merrill(1.040)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Mookie Betts(1.075)",
            "Will Smith(0.941)",
            "Teoscar Hernández(0.845)",
            "Freddie Freeman(0.569)",
            "Miguel Rojas(0.732)",
            "Kyle Tucker(1.126)",
            "Enrique Hernández(0.659)",
            "Alex Call(0.480)",
            "Josue De Paula(0.963)"
          ],
          "lineup_players": [
            {
              "id": 605141,
