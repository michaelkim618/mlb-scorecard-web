...
window.PREDICTIONS_DATA = [
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Roman Anthony(0.704)",
            "Mickey Gasper(0.659)",
            "Adley Rutschman(0.704)",
            "Wilyer Abreu(0.706)",
            "Nick Sogard(0.630)",
            "Trevor Story(0.719)",
            "Caleb Durbin(0.834)",
            "Jarren Duran(0.740)",
            "Isiah Kiner-Falefa(0.474)"
          ],
          "lineup_players": [
            {
              "id": 701350,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Junior Caminero(0.853)",
            "Liam Hicks(0.815)",
            "Chandler Simpson(0.700)",
            "Victor Mesa Jr.(1.096)",
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 3.8pt (≤5.0pt) / 최고 확률 50.0% (≤58.0%)",
    "model_version": "v15"
  },
  {
    "date": "2026-09-19",
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Dane Myers(0.595)",
            "Elly De La Cruz(0.970)",
            "Sal Stewart(0.750)",
            "Tyler Stephenson(0.647)",
            "Eugenio Suárez(0.764)",
            "Juan Brito(0.782)",
            "JJ Bleday(0.654)",
            "Matt McLain(0.392)",
            "Ke'Bryan Hayes(0.317)"
          ],
          "lineup_players": [
            {
              "id": 667472,
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Carter Jensen(0.876)",
            "Bobby Witt Jr.(0.762)",
            "Jac Caglianone(0.750)",
            "Vinnie Pasquantino(0.778)",
            "Michael Massey(0.707)",
            "Nick Loftin(0.722)",
            "John Rave(0.722)",
            "Kyle Isbel(0.445)",
            "Isaac Collins(0.560)"
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Konnor Griffin(0.688)",
            "Oneil Cruz(0.990)",
            "Bryan Reynolds(0.696)",
            "Rafael Flores Jr.(0.924)",
            "Brandon Lowe(0.971)",
            "Nick Gonzales(0.708)",
            "Ryan O'Hearn(0.611)",
            "Ronny Simon(0.833)",
    ...
    "scores": {
      "away_offense": 26.3,
      "away_defense": 43.1,
      "home_offense": 40.099999999999994,
      "home_defense": 43.6
    },
    "actual_score": {
      "away": 5,
    ...
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 53.6% (≤58.0%)",
    "model_version": "v15"
  },
  {
    "date": "2026-09-19",
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Brett Bateman(0.827)",
            "Vladimir Guerrero Jr.(0.768)",
            "Alejandro Kirk(0.830)",
            "George Springer(0.692)",
            "Nathan Lukes(0.649)",
            "Kazuma Okamoto(0.843)",
            "Josh Smith(0.631)",
            "Andrés Giménez(0.678)",
            "Myles Straw(0.584)"
          ],
          "lineup_players": [
            {
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Drake Baldwin(0.893)",
            "Ronald Acuña Jr.(0.913)",
            "Matt Olson(0.881)",
            "Michael Harris II(0.802)",
            "Mauricio Dubón(0.822)",
            "Ozzie Albies(0.629)",
            "Mike Yastrzemski(0.816)",
            "Austin Riley(0.583)",
            "Sean Murphy(0.420)"
          ],
          "lineup_players": [
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 3.0pt (≤5.0pt) / 최고 확률 52.0% (≤58.0%)",
    "model_version": "v15"
  },
  {
    "date": "2026-09-19",
  ...
  },
  {
    ...
    "home_pitcher": "Jose Quintana",
    "home_pitcher_id": 500779,
    "home_pitcher_stats": {
      "wins": 2,
      "losses": 3,
      "era": "5.40"
