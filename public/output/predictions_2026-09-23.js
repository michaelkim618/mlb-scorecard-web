...
window.PREDICTIONS_DATA = [
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Ben Rice(0.992)",
            "George Lombard Jr.(0.746)",
            "Luis García Jr.(0.580)",
            "Heliot Ramos(0.754)",
            "Spencer Jones(0.641)",
            "Jazz Chisholm Jr.(0.788)",
            "José Caballero(0.684)",
            "Ryan McMahon(0.542)",
            "Ali Sánchez(0.504)"
          ],
          "lineup_players": [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Jahmai Jones(0.578)",
            "Wilyer Abreu(0.612)",
            "Adley Rutschman(0.684)",
            "Ceddanne Rafaela(0.605)",
            "Caleb Durbin(0.797)",
            "Trevor Story(0.720)",
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Drake Baldwin(0.859)",
            "Mauricio Dubón(0.885)",
            "Matt Olson(0.911)",
            "Ozzie Albies(0.580)",
            "Michael Harris II(0.828)",
            "Austin Riley(0.688)",
            "Sean Murphy(0.402)",
  ...
  },
  {
    ...
    "model_correct": true,
    "notes": "Houston Astros IL: Brandon Walter, Brice Matthews, Carlos Correa, Cristian Javier, Daulton Varsho 외 다수 / Seattle Mariners IL: Brendan Donovan, Brennen Davis, Brock Rodden, Cole Wilcox, Colt Emerson 외 다수",
    "kalshi_prob": null,
    "edge": null,
    "value_bet": "마켓 없음",
    "extreme_edge": false,
