...
window.PREDICTIONS_DATA = [
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 2.3pt (≤5.0pt) / 최고 확률 50.6% (≤58.0%)",
    "model_version": "v15"
  },
  {
    "date": "2026-09-19",
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Ben Rice(1.018)",
            "Cody Bellinger(0.921)",
            "Luis García Jr.(0.751)",
            "Heliot Ramos(0.780)",
            "George Lombard Jr.(0.624)",
            "Austin Wells(0.791)",
            "Anthony Volpe(0.713)",
            "Ryan McMahon(0.471)",
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jonah Cox(0.723)",
            "Turner Hill(0.601)",
            "Victor Bericoto(0.694)",
            "Jung Hoo Lee(0.667)",
            "Brett Harris(0.496)",
            "Shay Whitcomb(0.555)",
            "Andrew Knizner(0.679)",
            "Osleivis Basabe(0.607)",
            "Christian Koss(0.621)"
          ],
          "lineup_players": [
            {
              "id": 813841,
