...
window.PREDICTIONS_DATA = [
  ...
  },
  {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Brice Turang(1.046)",
            "William Contreras(0.857)",
            "Andrew Vaughn(0.732)",
            "Christian Yelich(0.635)",
            "Joey Ortiz(0.902)",
            "Garrett Mitchell(0.891)",
            "Luis Lara(0.560)",
            "Cooper Pratt(0.717)"
          ],
          "lineup_players": [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Coby Mayo(0.873)",
            "Samuel Basallo(0.626)",
            "Christian Encarnacion-Strand(0.893)",
            "Colton Cowser(0.690)",
            "Jeremiah Jackson(0.630)",
            "Leody Taveras(0.524)"
          ],
          "lineup_players": [
            {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 2.0pt (≤5.0pt) / 최고 확률 53.7% (≤58.0%)",
    "model_version": "v14"
  },
  {
    "date": "2026-09-18",
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Yandy Díaz(0.615)",
            "Jonathan Aranda(0.806)",
            "Junior Caminero(0.827)",
            "Ryan Vilade(0.766)",
            "Chandler Simpson(0.698)",
            "Jonny DeLuca(0.634)",
            "Nick Fortes(0.843)",
            "Victor Mesa(1.058)",
            "Taylor Walls(0.643)"
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 4.5pt (≤5.0pt) / 최고 확률 53.0% (≤58.0%)",
    "model_version": "v14"
  },
  {
    "date": "2026-09-18",
