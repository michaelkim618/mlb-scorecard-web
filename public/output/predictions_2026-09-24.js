...
window.PREDICTIONS_DATA = [
  {
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Oneil Cruz(0.926)",
            "Konnor Griffin(0.750)",
            "Brandon Lowe(0.998)",
            "Ryan O'Hearn(0.713)",
            "Nick Gonzales(0.666)",
            "Ronny Simon(0.728)",
            "Spencer Horwitz(0.741)",
            "Jake Mangum(0.591)",
            "Henry Davis(0.672)"
          ],
          "lineup_players": [
    ...
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 56.0% (≤62.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Kyle Teel(0.684)",
            "Miguel Vargas(0.918)",
            "Munetaka Murakami(0.902)",
            "Andrew Benintendi(0.604)",
            "Tristan Peters(0.505)",
            "Chase Meidroth(0.897)",
            "Colson Montgomery(0.493)",
            "Braden Montgomery(0.692)"
          ],
          "lineup_players": [
            {
              "id": 803011,
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Otto Lopez(0.720)",
            "Heriberto Hernández(0.652)",
            "Jakob Marsee(0.910)",
            "Javier Sanoja(0.845)",
            "Agustín Ramírez(0.812)",
            "Esteury Ruiz(0.569)",
            "Deyvison De Los Santos(0.257)",
            "Jared Serna(0.502)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jake McCarthy(0.770)",
            "Connor Norby(0.848)",
            "Hunter Goodman(0.820)",
            "TJ Rumfield(0.809)",
            "Cole Carrigg(0.951)",
            "Kyle Karros(0.779)",
            "Brett Sullivan(0.571)",
            "Jordan Beck(0.479)",
            "Ezequiel Tovar(0.704)"
          ],
          "lineup_players": [
            {
              "id": 664983,
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Garrett Mitchell(0.660)",
            "Brice Turang(0.837)",
            "William Contreras(0.782)",
            "Jake Bauers(0.833)",
            "Gary Sánchez(0.802)",
            "Luis Lara(0.546)",
            "Cooper Pratt(0.788)",
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Carlos Jorge(0.620)",
            "Elly De La Cruz(1.014)",
            "Sal Stewart(0.711)",
            "Tyler Stephenson(0.576)",
            "JJ Bleday(0.652)",
            "Eugenio Suárez(0.754)",
            "Héctor Rodríguez(0.586)",
            "Matt McLain(0.528)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Drake Baldwin(0.871)",
            "Ronald Acuña Jr.(0.872)",
            "Matt Olson(0.825)",
            "Michael Harris II(0.774)",
            "Mauricio Dubón(0.826)",
            "Ozzie Albies(0.577)",
            "Mike Yastrzemski(0.811)",
            "Austin Riley(0.668)",
            "Sean Murphy(0.415)"
          ],
          "lineup_players": [
