// Auto-generated (scorecard) — 2026-09-18
window.PREDICTIONS_DATA = [
  {
    ...
    "home_pitcher": "Chase Burns",
    "home_pitcher_id": 695505,
    "home_pitcher_stats": {
      "wins": 15,
      "losses": 3,
      "era": "2.86"
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Carlos Jorge(0.417)",
            "Elly De La Cruz(1.026)",
            "Sal Stewart(0.829)",
            "Tyler Stephenson(0.694)",
            "JJ Bleday(0.599)",
            "Eugenio Suárez(0.780)",
            "Héctor Rodríguez(0.464)",
            "Jose Trevino(0.494)",
            "Matt McLain(0.441)"
          ],
          "lineup_players": [
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Carter Jensen(0.856)",
            "Bobby Witt(0.689)",
            "Vinnie Pasquantino(0.786)",
            "Maikel Garcia(0.660)",
            "Michael Massey(0.789)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Konnor Griffin(0.716)",
            "Brandon Lowe(0.952)",
            "Bryan Reynolds(0.679)",
            "Oneil Cruz(0.915)",
            "Nick Gonzales(0.680)",
            "Ryan O'Hearn(0.622)",
            "Ronny Simon(0.905)",
    ...
    "scores": {
      "away_offense": 22.5,
      "away_defense": 28.2,
      "home_offense": 34.599999999999994,
      "home_defense": 44.6
    },
    "actual_score": {
      "away": 5,
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 1.9pt (≤5.0pt) / 최고 확률 54.0% (≤58.0%)",
    "model_version": "v14"
  },
  {
    "date": "2026-09-18",
    ...
    "away_pitcher": "Mason Barnett",
    "away_pitcher_id": 686930,
    "away_pitcher_stats": {
      "wins": 1,
      "losses": 4,
      "era": "7.16"
    ...
    "home_pitcher": "Daniel Espino",
    "home_pitcher_id": 682982,
    "home_pitcher_stats": {
      "wins": 0,
      "losses": 0,
      "era": "4.73"
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Henry Bolte(0.752)",
            "Shea Langeliers(0.824)",
            "Lawrence Butler(0.815)",
            "Zack Gelof(0.674)",
            "Jeff McNeil(0.621)",
            "Tommy White(0.566)",
            "Jonah Heim(0.447)",
            "Michael Stefanic(0.645)",
            "Alika Williams(0.714)"
          ],
          "lineup_players": [
            {
              "id": 703607,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Steven Kwan(0.790)",
            "José Ramírez(0.611)",
            "Chase DeLauter(0.865)",
            "Jo Adell(0.722)",
            "Travis Bazzana(0.994)",
            "Nathaniel Lowe(0.815)",
            "Patrick Bailey(0.570)",
            "Petey Halpin(0.577)",
            "Brayan Rocchio(0.724)"
          ],
          "lineup_players": [
            {
              "id": 680757,
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 4.5pt (≤5.0pt) / 최고 확률 54.8% (≤58.0%)",
    "model_version": "v14"
  },
  {
    "date": "2026-09-18",
    ...
    "away_pitcher": "Tim Mayza",
    "away_pitcher_id": 641835,
    "away_pitcher_stats": {
      "wins": 3,
      "losses": 4,
      "era": "3.46"
    ...
    "scores": {
      "away_offense": 29.799999999999997,
      "away_defense": 37.8,
      "home_offense": 39.2,
      "home_defense": 44.2
    },
  ...
  },
  {
    ...
    "home_pitcher": "David Sandlin",
    "home_pitcher_id": 689818,
    "home_pitcher_stats": {
      "wins": 2,
      "losses": 2,
      "era": "6.29"
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Brett Bateman(0.808)",
            "Nathan Lukes(0.667)",
            "Vladimir Guerrero Jr.(0.748)",
            "George Springer(0.731)",
            "Alejandro Kirk(0.808)",
            "Kazuma Okamoto(0.936)",
            "Josh Smith(0.649)",
            "Ernie Clement(0.500)",
            "Myles Straw(0.631)"
          ],
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Ezequiel Duran(0.585)",
            "Corey Seager(0.791)",
            "Josh Jung(0.814)",
            "Brandon Nimmo(0.686)",
            "Wyatt Langford(0.747)",
            "Jake Burger(0.715)",
            "Nicky Lopez(0.719)",
            "Elias Díaz(0.693)",
            "Evan Carter(0.403)"
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "J.P. Crawford(0.689)",
            "Randy Arozarena(0.996)",
            "Dominic Canzone(0.844)",
            "Cal Raleigh(0.597)",
            "Julio Rodríguez(0.707)",
            "Josh Naylor(0.710)",
            "Cole Young(0.723)",
            "Lazaro Montes(1.046)",
            "Brock Rodden(0.553)"
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Drake Baldwin(0.904)",
            "Ronald Acuña Jr.(0.863)",
            "Matt Olson(0.886)",
            "Michael Harris II(0.835)",
            "Mauricio Dubón(0.837)",
            "Ozzie Albies(0.648)",
            "Mike Yastrzemski(0.663)",
            "Austin Riley(0.584)",
            "Sean Murphy(0.403)"
          ],
          "lineup_players": [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jeremy Peña(0.909)",
            "Yordan Alvarez(1.027)",
            "Isaac Paredes(0.838)",
            "Jose Altuve(0.643)",
            "Daulton Varsho(0.487)",
            "Christian Walker(0.523)",
            "Taylor Trammell(0.615)",
            "LaMonte Wade Jr.(0.752)",
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Luke Keaschall(0.750)",
            "Brooks Lee(0.647)",
            "Kody Clemens(0.774)",
            "Ryan Jeffers(0.683)",
            "Josh Bell(0.652)",
            "Emmanuel Rodriguez(0.621)",
            "Royce Lewis(0.469)",
            "Walker Jenkins(0.702)",
            "Ben Ross(0.429)"
          ],
          "lineup_players": [
            {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Mike Trout(0.766)",
            "Jose Siri(0.749)",
            "Vaughn Grissom(0.621)",
            "Denzer Guzman(0.648)",
            "Oswald Peraza(0.586)",
            "Travis d'Arnaud(0.434)",
            "Christian Moore(0.426)",
            "Wade Meckler(0.691)"
          ],
          "lineup_players": [
            {
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Kyle Stowers(0.577)",
            "Heriberto Hernández(0.645)",
            "Otto Lopez(0.847)",
            "Griffin Conine(0.722)",
            "Javier Sanoja(0.883)",
            "Jakob Marsee(0.940)",
            "Xavier Edwards(0.653)",
            "Joe Mack(0.662)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Fernando Tatis Jr.(0.921)",
            "Dustin Harris(0.831)",
            "Manny Machado(0.645)",
            "Ty France(0.908)",
            "Jackson Merrill(1.034)",
            "Xander Bogaerts(0.832)",
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 2.5pt (≤5.0pt)",
    "model_version": "v14"
  },
  {
    "date": "2026-09-18",
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Paul Goldschmidt(0.879)",
            "Cody Bellinger(0.958)",
            "Heliot Ramos(0.833)",
            "Ben Rice(0.983)",
            "Amed Rosario(0.661)",
            "Spencer Jones(0.710)",
            "George Lombard Jr.(0.693)",
            "Austin Wells(0.621)",
            "Anthony Volpe(0.675)"
          ],
          "lineup_players": [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Lars Nootbaar(0.716)",
            "Ketel Marte(0.693)",
            "Gabriel Moreno(0.936)",
            "Geraldo Perdomo(0.739)",
            "Pavin Smith(0.513)",
            "Nolan Arenado(1.048)",
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Jung Hoo Lee(0.637)",
            "Shay Whitcomb(0.621)",
            "Drew Cavanaugh(0.598)",
            "Brett Harris(0.429)",
            "Scott Bandura(0.641)",
            "Christian Koss(0.741)"
          ],
          "lineup_players": [
            {
              "id": 687551,
