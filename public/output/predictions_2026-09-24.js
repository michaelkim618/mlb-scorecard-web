...
window.PREDICTIONS_DATA = [
  {
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Oneil Cruz(0.911)",
            "Konnor Griffin(0.738)",
            "Brandon Lowe(0.981)",
            "Ryan O'Hearn(0.693)",
            "Nick Gonzales(0.667)",
            "Ronny Simon(0.728)",
            "Spencer Horwitz(0.726)",
            "Jake Mangum(0.615)",
            "Henry Davis(0.672)"
          ],
          "lineup_players": [
    ...
    "scores": {
      "away_offense": 25.0,
      "away_defense": 49.5,
      "home_offense": 29.400000000000002,
      "home_defense": 57.0
    },
    "actual_score": {
      "away": 1,
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Kyle Teel(0.683)",
            "Miguel Vargas(0.904)",
            "Munetaka Murakami(0.888)",
            "Andrew Benintendi(0.593)",
            "Tristan Peters(0.498)",
            "Chase Meidroth(0.897)",
            "Colson Montgomery(0.488)",
            "Braden Montgomery(0.714)"
          ],
          "lineup_players": [
            {
              "id": 803011,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Salvador Perez(0.620)",
            "Michael Massey(0.651)",
            "Nick Loftin(0.748)",
            "John Rave(0.788)",
            "Kyle Isbel(0.434)",
            "Isaac Collins(0.457)"
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 1.4pt (≤5.0pt) / 최고 확률 57.4% (≤62.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
  ...
  },
  {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Jake Burger(0.671)",
            "Brandon Nimmo(0.681)",
            "Wyatt Langford(0.716)",
            "Ezequiel Duran(0.532)",
            "Elias Díaz(0.580)",
            "Danny Jansen(0.640)"
          ],
          "lineup_players": [
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "최고 확률 54.8% (≤62.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jake McCarthy(0.751)",
            "Connor Norby(0.848)",
            "Hunter Goodman(0.807)",
            "TJ Rumfield(0.826)",
            "Cole Carrigg(0.951)",
            "Kyle Karros(0.768)",
            "Brett Sullivan(0.571)",
            "Jordan Beck(0.479)",
            "Ezequiel Tovar(0.730)"
          ],
          "lineup_players": [
            {
              "id": 664983,
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Garrett Mitchell(0.650)",
            "Brice Turang(0.856)",
            "William Contreras(0.759)",
            "Jake Bauers(0.838)",
            "Gary Sánchez(0.802)",
            "Luis Lara(0.538)",
            "Cooper Pratt(0.788)",
    ...
    "scores": {
      "away_offense": 29.099999999999998,
      "away_defense": 59.6,
      "home_offense": 25.0,
      "home_defense": 54.4
    },
    ...
    "model_correct": false,
    "notes": "Milwaukee Brewers IL: Andrew Vaughn, Angel Zerpa, Brandon Woodruff, Brian Fitzpatrick, Grant Anderson 외 다수 / Philadelphia Phillies IL: Adolis García, Brad Keller, Caleb Kilian, Felix Reyes, Jesús Luzardo 외 다수",
    "kalshi_prob": null,
    "edge": null,
    "value_bet": "마켓 없음",
    "extreme_edge": false,
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Steven Kwan(0.732)",
            "José Ramírez(0.748)",
            "Chase DeLauter(0.722)",
            "Jo Adell(0.656)",
            "Angel Martínez(1.047)",
            "David Fry(0.605)",
            "Travis Bazzana(0.705)",
            "Patrick Bailey(0.539)",
            "Brayan Rocchio(0.713)"
          ],
          "lineup_players": [
            {
              "id": 680757,
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Carlos Jorge(0.643)",
            "Elly De La Cruz(1.005)",
            "Sal Stewart(0.694)",
            "Tyler Stephenson(0.576)",
            "JJ Bleday(0.642)",
            "Eugenio Suárez(0.742)",
            "Héctor Rodríguez(0.576)",
            "Matt McLain(0.528)",
