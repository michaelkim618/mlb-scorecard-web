...
window.PREDICTIONS_DATA = [
  {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Andrew Benintendi(0.698)",
            "Colson Montgomery(0.576)",
            "Chase Meidroth(0.818)",
            "Braden Montgomery(0.419)",
            "Brenton Doyle(0.729)"
          ],
          "lineup_players": [
            {
    ...
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 2.8pt (≤5.0pt) / 최고 확률 51.3% (≤58.0%)",
    "model_version": "v15"
  },
  {
    "date": "2026-09-19",
  ...
  },
  {
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 4.1pt (≤5.0pt)",
    "model_version": "v15"
  },
  {
    "date": "2026-09-19",
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Heliot Ramos(0.827)",
            "George Lombard Jr.(0.718)",
            "Austin Wells(0.756)",
            "Anthony Volpe(0.721)",
            "Ryan McMahon(0.471)",
            "José Caballero(0.711)"
          ],
          "lineup_players": [
            {
              "id": 700250,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Lars Nootbaar(0.702)",
            "Ketel Marte(0.684)",
            "Gabriel Moreno(0.986)",
            "Geraldo Perdomo(0.740)",
            "Corbin Carroll(0.785)",
            "Nolan Arenado(1.103)",
            "Tim Tawa(0.644)",
            "Jesús Sánchez(0.570)",
            "Jordan Lawlar(0.828)"
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jonah Cox(0.689)",
            "Turner Hill(0.601)",
            "Victor Bericoto(0.663)",
            "Jung Hoo Lee(0.697)",
            "Brett Harris(0.458)",
            "Shay Whitcomb(0.532)",
            "Andrew Knizner(0.647)",
            "Osleivis Basabe(0.607)",
            "Christian Koss(0.599)"
          ],
          "lineup_players": [
            {
              "id": 813841,
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Mookie Betts(1.028)",
            "Freddie Freeman(0.572)",
            "Will Smith(0.922)",
            "Max Muncy(0.849)",
            "Teoscar Hernández(0.746)",
            "Kyle Tucker(1.126)",
            "Josue De Paula(1.005)",
            "Tommy Edman(0.532)",
            "Alex Freeland(0.839)"
          ],
          "lineup_players": [
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Mike Trout(0.781)",
            "Wade Meckler(0.651)",
            "Vaughn Grissom(0.657)",
            "Moisés Ballesteros(0.664)",
            "Denzer Guzman(0.564)",
            "Josh Lowe(0.679)",
            "Jose Siri(0.777)",
