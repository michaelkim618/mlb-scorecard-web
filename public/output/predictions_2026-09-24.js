...
window.PREDICTIONS_DATA = [
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Otto Lopez(0.720)",
            "Heriberto Hernández(0.660)",
            "Jakob Marsee(0.910)",
            "Javier Sanoja(0.858)",
            "Agustín Ramírez(0.830)",
            "Esteury Ruiz(0.569)",
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 1.6pt (≤5.0pt) / 최고 확률 60.0% (≤62.0%)",
    "opener_game": {
      "away": false,
      "home": false
    },
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Matt Olson(0.825)",
            "Michael Harris II(0.784)",
            "Mauricio Dubón(0.826)",
            "Ozzie Albies(0.583)",
            "Mike Yastrzemski(0.831)",
            "Austin Riley(0.669)",
            "Sean Murphy(0.415)"
          ],
          "lineup_players": [
