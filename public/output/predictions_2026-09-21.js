// Auto-generated (scorecard) — 2026-09-21
window.PREDICTIONS_DATA = [
  ...
  },
  {
    ...
    "away_pitcher": "DJ Herz",
    "away_pitcher_id": 687792,
    "away_pitcher_stats": {
      "wins": 0,
      "losses": 1,
      "era": "9.00"
    ...
    "home_pitcher": "River Ryan",
    "home_pitcher_id": 689981,
    "home_pitcher_stats": {
      "wins": 0,
      "losses": 0,
      "era": "0.00"
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 0.2pt (≤5.0pt)",
    "model_version": "v15"
  },
  {
    "date": "2026-09-21",
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Walker Jenkins(0.737)",
            "Luke Keaschall(0.728)",
            "Brooks Lee(0.774)",
            "Kody Clemens(0.580)",
            "Ryan Jeffers(0.570)",
            "Alan Roden(0.881)",
            "Aaron Sabato(0.000)",
            "Emmanuel Rodriguez(0.635)",
            "Ryan Kreidler(0.720)"
          ],
          "lineup_players": [
            {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Marcelo Mayer(0.560)",
            "Brett Harris(0.577)",
            "Drew Cavanaugh(0.553)",
            "Osleivis Basabe(0.585)",
            "Scott Bandura(0.477)",
            "Christian Koss(0.555)"
          ],
          "lineup_players": [
            {
              "id": 687551,
