...
window.PREDICTIONS_DATA = [
  ...
  },
  {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Dylan Beavers(0.632)",
            "Pete Alonso(0.957)",
            "Gunnar Henderson(0.741)",
            "Coby Mayo(0.873)",
            "Samuel Basallo(0.636)",
    ...
    "sp_bat_conflict_detail": null,
    "low_confidence": true,
    "low_confidence_reason": "SP 점수 차이 2.0pt (≤5.0pt) / 최고 확률 54.0% (≤58.0%)",
    "model_version": "v14"
  },
  {
    "date": "2026-09-18",
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            ...
            "Colt Keith(0.774)",
            "Riley Greene(0.971)",
            "Spencer Torkelson(0.997)",
            "Zach McKinstry(0.469)",
            "Max Clark(0.888)",
            "Eduardo Valencia(0.877)",
            "Hao-Yu Lee(0.833)"
          ],
          "lineup_players": [
            {
