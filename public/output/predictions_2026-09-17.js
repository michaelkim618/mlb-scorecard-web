...
window.PREDICTIONS_DATA = [
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Henry Bolte(0.851)",
            "Jeff McNeil(0.616)",
            "Lawrence Butler(0.777)",
            "Zack Gelof(0.680)",
            "Donovan Walton(0.731)",
            "Tommy White(0.566)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Yandy Díaz(0.605)",
            "Jonathan Aranda(0.852)",
            "Junior Caminero(0.899)",
            "Liam Hicks(0.782)",
            "Jonny DeLuca(0.645)",
  ...
  },
  {
    ...
    "scorecard": {
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "lineup_ops": [
            "Jeremy Peña(0.909)",
            "Yordan Alvarez(1.006)",
            "Isaac Paredes(0.843)",
            "Jose Altuve(0.621)",
            "Yainer Diaz(0.829)",
            "Daulton Varsho(0.613)",
            "Taylor Trammell(0.637)",
            "Cam Smith(0.678)",
            "LaMonte Wade Jr.(0.691)"
          ],
          "lineup_players": [
            {
              "id": 665161,
    ...
    "scores": {
      "away_offense": 17.2,
      "away_defense": 20.7,
      "home_offense": 32.300000000000004,
      "home_defense": 43.9
    },
    "actual_score": {
      "away": 2,
    ...
    "scorecard": {
      ...
      "away": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Kevin McGonigle(0.967)",
            "Gleyber Torres(0.659)",
            "Dillon Dingler(0.571)",
            "Riley Greene(0.841)",
            "Spencer Torkelson(0.956)",
      ...
      "home": {
        ...
        "bat_detail": {
          ...
          "splits_used": false,
          "lineup_ops": [
            "Chase Meidroth(0.817)",
            "Tommy Pham(0.519)",
            "Miguel Vargas(0.793)",
            "Randal Grichuk(1.000)",
            "Munetaka Murakami(0.757)",
            "Brenton Doyle(0.746)",
            "Jake Rogers(0.456)",
            "Luisangel Acuña(0.483)",
            "Braden Montgomery(0.488)"
          ],
          "lineup_players": [
            {
              "id": 805367,
